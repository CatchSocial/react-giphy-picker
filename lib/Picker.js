...
var _default = /*#__PURE__*/function (_Component) {
  ...
  function _default(props) {
    ...
    _this.state = {
      gifs: [],
      searchValue: '',
      giphySearchUrl: "https//api.giphy.com/v1/gifs/search?api_key=".concat(_this.props.apiKey),
      giphyTrendingUrl: "https://api.giphy.com/v1/gifs/trending?api_key=".concat(_this.props.apiKey)
    };
